...
$(document).ready(function () {
    ...
    $('.detail-qty').each(function () {
        let $this = $(this);
        // let max_price = $('#.qty-val').val()
        let qtyval = parseInt($this.find('.qty-val').text(), 10);
        qtyval2 = parseInt($(this).find('.qtty').val(), 10);
        ...
        $this.find('.qty-up').on('click', function (event) {
            ...
            console.log('qtval' + qtyval)
            qtyval2 = qtyval
            console.log('qtval2' + qtyval2)
        });
    ...
    $('.add-to-cart-btn').on('click', function () {
        ...
        console.log(price+'cccccccccccccccccccccccccccccccccccc')
